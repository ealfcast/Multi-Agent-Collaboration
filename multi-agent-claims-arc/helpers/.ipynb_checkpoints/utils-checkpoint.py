...
SSM_RAG_AGENT_ARN = "/app/aws_rag_assistant/agentcore/agent_arn"
...
AWS_RAG_ROLE_NAME =  f"AWSClaimsRagAssistantBedrockAgentCoreRole-{REGION}"
AWS_LEGALVALIDATION_ROLE_NAME =  f"AWSLegalValidationAssistantBedrockAgentCoreRole-{REGION}"
